...
(function () {
  ...
  function crearProductCard(producto) {
    ...
    // Imagen con fallback (soporta imagenes[] array o imagen string)
  ...
  function mostrarResultadosBusqueda(resultados, dropdown) {
    ...
    resultados.forEach(function (producto) {
      ...
      item.innerHTML =
        '<img class="search-result__img" src="' + ((producto.imagenes && producto.imagenes.length > 0) ? producto.imagenes[0] : producto.imagen) + '" alt="' + producto.nombre + '" onerror="this.src=\'assets/img/productos/placeholder-impresora.jpg\'">' +
  ...
  function agregarAlCarrito(productoId, cantidad) {
    ...
    if (existente) {
      ...
      carrito.push({
        ...
        imagen: (producto.imagenes && producto.imagenes.length > 0) ? producto.imagenes[0] : producto.imagen,
        cantidad: cantidad
      });
    }
